...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'apb_platform.antispam' => 'getApbPlatform_AntispamService',
    ...
    /**
     * Gets the 'apb_platform.antispam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \APB\PlatformBundle\Antispam\APBAntispam A APB\PlatformBundle\Antispam\APBAntispam instance.
     */
    protected function getApbPlatform_AntispamService()
    {
        return $this->services['apb_platform.antispam'] = new \APB\PlatformBundle\Antispam\APBAntispam($this->get('swiftmailer.mailer.default'), 'en', 50);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\APB\\PlatformBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\PM\\TPBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'APB\\PlatformBundle\\Entity');
        $c->addDriver($b, 'PM\\TPBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('APBPlatformBundle' => 'APB\\PlatformBundle\\Entity', 'PMTPBundle' => 'PM\\TPBundle\\Entity'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\APB\\PlatformBundle/Resources/views'), 'APBPlatform');
        $instance->addPath(($this->targetDirs[3].'\\src\\PM\\TPBundle/Resources/views'), 'PMTP');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('8953d18e7ed9fedcf23a69427cb17f523d2273cf');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56796939516737.84581288')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'APBPlatformBundle' => 'APB\\PlatformBundle\\APBPlatformBundle',
                'PMTPBundle' => 'PM\\TPBundle\\PMTPBundle',
            ...
            'secret' => '8953d18e7ed9fedcf23a69427cb17f523d2273cf',
            'locale' => 'en',
            ...
            'kernel.secret' => '8953d18e7ed9fedcf23a69427cb17f523d2273cf',
