...
namespace Proxies\__CG__\APB\PlatformBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \APB\PlatformBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'APB\\PlatformBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'APB\\PlatformBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'APB\\PlatformBundle\\Entity\\Image' . "\0" . 'alt');
        }
